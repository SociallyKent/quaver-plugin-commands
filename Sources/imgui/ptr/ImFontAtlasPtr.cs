...
public struct ImFontAtlasPtr
{
  ...
  public unsafe ImFontAtlasPtr(IntPtr nativePtr) => this.NativePtr = (ImFontAtlas*) nativePtr;
  ...
  {
    get => (IntPtr) this.NativePtr->TexPixelsAlpha8;
    set => this.NativePtr->TexPixelsAlpha8 = (byte*) value;
  }

  public unsafe IntPtr TexPixelsRGBA32
  {
    get => (IntPtr) this.NativePtr->TexPixelsRGBA32;
    set => this.NativePtr->TexPixelsRGBA32 = (uint*) value;
  }
  ...
  {
    get => new RangeAccessor<Vector4>((void*) &this.NativePtr->TexUvLines_0, 64 /*0x40*/);
  }

  public unsafe IntPtr FontBuilderIO
  {
    get => (IntPtr) this.NativePtr->FontBuilderIO;
    set => this.NativePtr->FontBuilderIO = (IntPtr*) value;
  }
  ...
  public unsafe ref int PackIdLines => ref Unsafe.AsRef<int>((void*) &this.NativePtr->PackIdLines);
  ...
  public unsafe ImFontPtr AddFontFromFileTTF(ReadOnlySpan<char> filename, float size_pixels)
  {
    int utf8ByteCount = 0;
    byte* numPtr;
    if (filename != (ReadOnlySpan<char>) (char[]) null)
    {
  ...
  public unsafe ImFontPtr AddFontFromMemoryCompressedBase85TTF(
    ReadOnlySpan<char> compressed_font_data_base85,
    float size_pixels)
  {
    int utf8ByteCount = 0;
    byte* numPtr;
    if (compressed_font_data_base85 != (ReadOnlySpan<char>) (char[]) null)
    {
    ...
    float size_pixels)
  {
    ...
    ImFontConfig* font_cfg = (ImFontConfig*) null;
    ushort* glyph_ranges = (ushort*) null;
    return new ImFontPtr(ImGuiNative.ImFontAtlas_AddFontFromMemoryCompressedTTF(this.NativePtr, pointer, compressed_font_data_size, size_pixels, font_cfg, glyph_ranges));
  }
    ...
    ImFontConfigPtr font_cfg)
  {
    ...
    ushort* glyph_ranges = (ushort*) null;
    return new ImFontPtr(ImGuiNative.ImFontAtlas_AddFontFromMemoryCompressedTTF(this.NativePtr, pointer, compressed_font_data_size, size_pixels, nativePtr, glyph_ranges));
  }
    ...
    IntPtr glyph_ranges)
  {
    ...
    return new ImFontPtr(ImGuiNative.ImFontAtlas_AddFontFromMemoryCompressedTTF(this.NativePtr, pointer1, compressed_font_data_size, size_pixels, nativePtr, pointer2));
  }
    ...
    float size_pixels)
  {
    ...
    ImFontConfig* font_cfg = (ImFontConfig*) null;
    ushort* glyph_ranges = (ushort*) null;
    return new ImFontPtr(ImGuiNative.ImFontAtlas_AddFontFromMemoryTTF(this.NativePtr, pointer, font_data_size, size_pixels, font_cfg, glyph_ranges));
  }
    ...
    ImFontConfigPtr font_cfg)
  {
    ...
    ImFontConfig* nativePtr = font_cfg.NativePtr;
    ushort* glyph_ranges = (ushort*) null;
    return new ImFontPtr(ImGuiNative.ImFontAtlas_AddFontFromMemoryTTF(this.NativePtr, pointer, font_data_size, size_pixels, nativePtr, glyph_ranges));
  }
    ...
    IntPtr glyph_ranges)
  {
    ...
    ImFontConfig* nativePtr = font_cfg.NativePtr;
    ushort* pointer2 = (ushort*) glyph_ranges.ToPointer();
    return new ImFontPtr(ImGuiNative.ImFontAtlas_AddFontFromMemoryTTF(this.NativePtr, pointer1, font_data_size, size_pixels, nativePtr, pointer2));
  }
  ...
  {
    return (IntPtr) ImGuiNative.ImFontAtlas_GetGlyphRangesChineseFull(this.NativePtr);
  }

  public unsafe IntPtr GetGlyphRangesChineseSimplifiedCommon()
  {
    return (IntPtr) ImGuiNative.ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon(this.NativePtr);
  }

  public unsafe IntPtr GetGlyphRangesCyrillic()
  {
    return (IntPtr) ImGuiNative.ImFontAtlas_GetGlyphRangesCyrillic(this.NativePtr);
  }

  public unsafe IntPtr GetGlyphRangesDefault()
  {
    return (IntPtr) ImGuiNative.ImFontAtlas_GetGlyphRangesDefault(this.NativePtr);
  }

  public unsafe IntPtr GetGlyphRangesGreek()
  {
    return (IntPtr) ImGuiNative.ImFontAtlas_GetGlyphRangesGreek(this.NativePtr);
  }

  public unsafe IntPtr GetGlyphRangesJapanese()
  {
    return (IntPtr) ImGuiNative.ImFontAtlas_GetGlyphRangesJapanese(this.NativePtr);
  }

  public unsafe IntPtr GetGlyphRangesKorean()
  {
    return (IntPtr) ImGuiNative.ImFontAtlas_GetGlyphRangesKorean(this.NativePtr);
  }

  public unsafe IntPtr GetGlyphRangesThai()
  {
    return (IntPtr) ImGuiNative.ImFontAtlas_GetGlyphRangesThai(this.NativePtr);
  }

  public unsafe IntPtr GetGlyphRangesVietnamese()
  {
    return (IntPtr) ImGuiNative.ImFontAtlas_GetGlyphRangesVietnamese(this.NativePtr);
  }
