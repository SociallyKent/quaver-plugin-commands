...
public struct ImGuiStylePtr
{
  ...
  public unsafe ImGuiStylePtr(IntPtr nativePtr) => this.NativePtr = (ImGuiStyle*) nativePtr;
  ...
  public unsafe ref float TabBarBorderSize
  {
    get => ref Unsafe.AsRef<float>((void*) &this.NativePtr->TabBarBorderSize);
  }

  public unsafe ref float TabBarOverlineSize
  {
    get => ref Unsafe.AsRef<float>((void*) &this.NativePtr->TabBarOverlineSize);
  }

  public unsafe ref float TableAngledHeadersAngle
  {
    get => ref Unsafe.AsRef<float>((void*) &this.NativePtr->TableAngledHeadersAngle);
  }

  public unsafe ref Vector2 TableAngledHeadersTextAlign
  {
    get => ref Unsafe.AsRef<Vector2>((void*) &this.NativePtr->TableAngledHeadersTextAlign);
  }
  ...
  public unsafe ref float SeparatorTextBorderSize
  {
    get => ref Unsafe.AsRef<float>((void*) &this.NativePtr->SeparatorTextBorderSize);
  }

  public unsafe ref Vector2 SeparatorTextAlign
  {
    get => ref Unsafe.AsRef<Vector2>((void*) &this.NativePtr->SeparatorTextAlign);
  }

  public unsafe ref Vector2 SeparatorTextPadding
  {
    get => ref Unsafe.AsRef<Vector2>((void*) &this.NativePtr->SeparatorTextPadding);
  }
  ...
  public unsafe ref float DockingSeparatorSize
  {
    get => ref Unsafe.AsRef<float>((void*) &this.NativePtr->DockingSeparatorSize);
  }
  ...
  {
    get => new RangeAccessor<Vector4>((void*) &this.NativePtr->Colors_0, 58);
  }

  public unsafe ref float HoverStationaryDelay
  {
    get => ref Unsafe.AsRef<float>((void*) &this.NativePtr->HoverStationaryDelay);
  }

  public unsafe ref float HoverDelayShort
  {
    get => ref Unsafe.AsRef<float>((void*) &this.NativePtr->HoverDelayShort);
  }

  public unsafe ref float HoverDelayNormal
  {
    get => ref Unsafe.AsRef<float>((void*) &this.NativePtr->HoverDelayNormal);
  }

  public unsafe ref ImGuiHoveredFlags HoverFlagsForTooltipMouse
  {
    get => ref Unsafe.AsRef<ImGuiHoveredFlags>((void*) &this.NativePtr->HoverFlagsForTooltipMouse);
  }

  public unsafe ref ImGuiHoveredFlags HoverFlagsForTooltipNav
  {
    get => ref Unsafe.AsRef<ImGuiHoveredFlags>((void*) &this.NativePtr->HoverFlagsForTooltipNav);
  }
